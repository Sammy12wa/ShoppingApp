...
public class SavedAdapter extends BaseAdapter {
  ...
  public ArrayList<HashMap<String, String>> list;
    ...
    public SavedAdapter(Activity activity, ArrayList<HashMap<String,String>> list){
        super();
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view ==null){
           view = inflater.inflate(R.layout.saved_screen_model, null);

            txtFirst =(TextView) view.findViewById(R.id.tvProductName);
            txtSecond = (TextView) view.findViewById(R.id.tvPrice);
            txtThird = (TextView) view.findViewById(R.id.tvCode);
            //txtForth = (TextView) view.findViewById(R.id.tvsubTotal);
            imageView = (ImageView) view.findViewById(R.id.imgProductIcon);
        }

        HashMap<String, String> map = list.get(i);
        txtThird.setText(map.get(FIRST_COLUMN));
        txtFirst.setText(map.get(SECOND_COLUMN));
        txtSecond.setText(map.get(THIRD_COLUMN));
        //txtForth.setText(map.get(FORTH_COLUMN));
        imageView.setImageBitmap(new SuperClass().returnBitmapImage(map.get(FORTH_COLUMN)));
